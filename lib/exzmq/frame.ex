...
defmodule Exzmq.Frame do
  ...
  def decode_greeting({1,0}, frame_len, _idflags, msg, data) when :erlang.size(msg) < frame_len - 1 do
    {:more, data}
  end
  ...
  def decode(_ver, frame_len, _flags, msg, data) when :erlang.size(msg) < frame_len - 1 do
   {:more, data}
  end
